...
@Component
public class RaisedAlertListener {
    private final StompSessionHandler stompSessionHandler;
    private final String raisedAlertsWebsocketEndpoint;

    public RaisedAlertListener(StompSessionHandler stompSessionHandler, @Value("${websocket.raised.alert.endpoint}") String raisedAlertsWebsocketEndpoint) {
